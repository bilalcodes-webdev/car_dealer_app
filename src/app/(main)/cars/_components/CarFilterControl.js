...
const CarFilterControl = ({
  ...
  const bodyType = currentFilters?.bodyType || "";
  const fuelType = currentFilters?.fuelType || "";
  const transmission = currentFilters?.transmission || "";
  const priceRange = currentFilters?.priceRange || [0, 1000000];
