...
import { bodyTypes, carMakes, faqItems } from "../../data/data";
...
import { getFeaturedCars } from "@/actions/homepage";
...
const HomePage = async () => {
  ...
  return (
    <div className="mt-20 flex flex-col">
      {/* Hero */}
      <section className="dotted-backgroud relative py-16 md:py-28 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-4">
            <h1 className="text-4xl font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-blue-500 to-green-500 pr-2 pb-2">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button size="lg" variant="secondary" asChild>
              <Link href="/cars" className="animate-bounce">
                View All Cars
              </Link>
            </Button>
            <SignedOut>
